...
public class ReadExpensesDto {
    ...
    public ReadExpensesDto(Long id, String title, String description, Integer mileage,
                           Integer volume, Double totalSum, String date, Integer icon,
                           String photoURI, Long timeForMillis, Integer month, Integer year,
                           Integer reserve1, Integer reserve2, String reserveString, String reserveString2,
                           LocalDateTime dtCreate, LocalDateTime dtUpdate, String author) {
        this.id = id;
        this.title = title;
    ...
    public static final class Builder {
        ...
        public ReadExpensesDto build(){
            return new ReadExpensesDto(id, title, description, mileage, volume, totalSum, date, icon, photoURI,
